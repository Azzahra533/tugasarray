...
public class perpustakaan {
    public static void main(String[] args) {
        ...
        dataMahasiswa.add(new Mahasiswa("20200040098", "Azzahra"));
        dataMahasiswa.add(new Mahasiswa("20200040079", "jake"));
        dataMahasiswa.add(new Mahasiswa("20200040081", "Raina"));
        
         ArrayList <Buku> dataBuku = new ArrayList<>(); 

    dataBuku.add(new Buku("1", "The Progmatic Programmer: Yout Journey to Mastery"));
    dataBuku.add(new Buku("2", "Introduction to Algorithms"));
    dataBuku.add(new Buku("3", "Learning Web Desisgn"));
